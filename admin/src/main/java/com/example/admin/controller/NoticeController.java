...
import com.example.admin.service.INoticeService;
...
public class NoticeController {
    ...
    @GetMapping("/page")
    public Result list(@RequestParam String title, @RequestParam Integer pageNum, @RequestParam Integer pageSize) {
